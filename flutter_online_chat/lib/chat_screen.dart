...
import 'package:flutter_online_chat/chat_message.dart';
import 'package:flutter_online_chat/text_composer.dart';
import 'dart:io';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                appBar: AppBar(
                  title: Text(
                    _currentUser != null ? "Logado como ${_currentUser.displayName}" : "Online Chat"
                  ),
                  elevation: 0,
                  centerTitle: true,
                  actions: [
